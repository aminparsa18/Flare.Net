...
// LanguageSwitcher - otherwise a direct hit on /login (bookmark, browser back) would
// render in the wrong locale until hydration catches up. paraglideMiddleware runs the
// configured strategy chain (cookie -> preferredLanguage -> baseLocale, see
