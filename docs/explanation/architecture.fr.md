<!-- Translated (fr) from docs/explanation/architecture.md · source-sha256:7e9a0b016e5539a1 · hand-translated by Claude, not generated by scripts/translate-docs.py - edit the source file and retranslate if it changes, don't machine-retranslate over this. -->
