...
| Роль | Может делать |
|---|---|
| `Viewer` | Читать логи, трассировки, метрики, сохранённые представления, статус приёма данных/конвейера/индексации; создавать/отзывать собственные персональные токены доступа. |
