...
This is the v1 roadmap's **"Getting-started docs with a snippet per logger"** item -
the last one before v1 is feature-complete (see [Planning.md](../Planning.md)).
...
See the [root README](../README.md#quickstart) if you haven't already. This gets you:

- **OTLP receiver** (what this page points your logger at) — gRPC on `:4317`, HTTP on `:4318`
- **Dashboard** — [http://localhost:3000](http://localhost:3000), where the logs below show up
